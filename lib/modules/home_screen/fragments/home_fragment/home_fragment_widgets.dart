              ...
              children: [
                SizedBox(
                  ...
                  child: ClipRRect(
                    ...
                    child: AspectRatio(
                      aspectRatio: 1 / 1,
                      child: Image.network(
                        "https://berita.99.co/wp-content/uploads/2021/06/winnetnewscom.jpg",
                      ),
                    ),
                  ),
                ),
                Flexible(
                  child: Padding(
                    ...
                    child: Text(
                      "${i + 1}. Kabar Petang: Belum sempat dilempari gas air mata, para demonstran yang patah hati sudah lebih dulu menangis karna teringat mantan.",
                    ),
                  ),
                ),
              ],
